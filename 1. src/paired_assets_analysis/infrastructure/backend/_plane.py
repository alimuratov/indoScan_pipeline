"""Plane fitting and depth computation utilities."""
...
def segment_plane_road(
    ...
    Returns (plane_model, inlier_mask) where plane_model is (a, b, c, d) for
    ax + by + cz + d = 0, and inlier_mask is a boolean array for road points.
    """
    if len(pcd.points) == 0:
